...
if (needCLodop()) {
    var clodopHost = window.CLODOP_HOST || "localhost";
    var src1 = "http://" + clodopHost + ":8000/CLodopfuncs.js?priority=1";
    var src2 = "http://" + clodopHost + ":18000/CLodopfuncs.js?priority=0";
